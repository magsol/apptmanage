...
<div id="outer">
	...
	<div id="content">
      ...
      <h4>Thanks for registering with us, {$firstName|capitalize:true}. An email has 
          been sent to you confirming your registration.  You will also now be able to login 
          with your username (email address) and password.</h4>
				<center>
				...
				<p>
					<div id="search">
						<input type="submit" class="submit" value="Return to Login" />
					</div>
				</form>   
                </p>
