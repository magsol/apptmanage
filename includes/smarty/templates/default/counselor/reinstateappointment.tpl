	...
	<div id="content">
		...
		<div id="normalcontent">
			...
			<div class="contentarea">
               ...
               <h4>Do you wish to make yourself available on {$dayname|capitalize:true}, {$date} at {$time}?</h4>
               <br />
               <p>Currently, you are listed as unavailable on {$dayname|capitalize:true}, {$date} at {$time}  Would you
               like to be listed as available for appointments?</p>
              <form method="post" action="appointment.php">
					
                    <table cellspacing="10">
                      <tr>
                      <td>
                        <label><input type="radio" name="reinstate" value="yes" checked="checked" /> YES, make me available again.</label>
                      </td>
                      </tr>
                      <tr>
                      <td>
                        <label><input type="radio" name="reinstate" value="no" /> NO.  I do not wish to be available on {$date} at {$time}.</label>
                      </td>
                      </tr>
                </table>
                 ...
                 <h4>
					  ...
					  <input type="submit" class="submit" value="Submit Choice" />
                      </span></div>
